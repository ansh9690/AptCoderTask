...
from core.views import HomeView, course_list, EnrolledCourseDetailView, CourseDetailView, add_course, CourseListView, StudentDetailView, TeacherDetailView, StudentEnrollCourseView, StudentCourseListView
...
urlpatterns = [
    ...
    path('enrolled/<slug:slug>/details/', EnrolledCourseDetailView.as_view(), name='enrolled_course_detail'),
